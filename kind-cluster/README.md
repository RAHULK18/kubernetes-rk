...
kubectl proxy --address='0.0.0.0' --port=8001 --accept-hosts='.*' # open the port at sg
http://localost:8001/api/v1/namespaces/kubernetes-dashboard/services/https:kubernetes-dashboard:/proxy/
